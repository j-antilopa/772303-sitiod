...
if __name__ == "__main__":
    while True:
        print('',
              '1. convert_csv_to_json',
              '2. load_json_into_db',
              '3. generate_urls_list',
              '4. generate_ips_list_who_visited_url',
              '5. generate_urls_visited_in_certain_time_period',
              '6. generate_urls_visited_by_certain_ip',
              '7. generate_urls_list_with_total_time_spent',
              '8. generate_urls_list_with_visit_sum',
              '9. generate_urls_list_with_days_time_count',
              '10. generate_ips_list_with_amount_and_time_spent_sum',
              '11. exit', sep='\n')
        try:
            ...
            if choice == 5:
                start_timestamp = int(input('input start timestamp: '))
                end_timestamp = int(input('input end timestamp: '))
